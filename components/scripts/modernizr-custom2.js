...
!function (e, n, t) {
    ...
    function v(e, n, o, s) {
        ...
        for (c = e.length, d = 0; c > d; d++)if (v = e[d], h = P.style[v], a(v, "-") && (v = i(v)), P.style[v] !== t) {
    ...
    var x = n.documentElement, w = "svg" === x.nodeName.toLowerCase(), S = "Moz O ms Webkit", b = _._config.usePrefixes ? S.split(" ") : [];
    _._cssomPrefixes = b;
    var E = function (n) {
